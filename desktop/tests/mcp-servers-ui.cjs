  ...
  try {
    ...
    await page.addInitScript(() => {
      ...
      window.codex = { connect: async () => ({ ok: true }), notify: async () => ({}), request: async (method, params) => {
        ...
        if (method === 'mcpServerStatus/list' && params.detail === 'full') return { ok: true, result: { data: [{ name: 'local', authStatus: 'unsupported', resources: [{ uri: 'fixture://readme', name: 'Readme' }], resourceTemplates: [{ uriTemplate: 'fixture://notes/{id}', name: 'Notes' }, { uriTemplate: 'fixture://search{?q,page}', name: 'Search' }, { uriTemplate: 'fixture://broken/{id', name: 'Broken' }] }] } };
    ...
    await page.getByText('资源模板 (3)', { exact: true }).click();
