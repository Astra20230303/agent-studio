...
export type TaskRun = { configuration?: TaskRunConfiguration; threadId?: string; id: string; status: 'running' | 'completed' | 'failed' | 'interrupted'; trigger: 'manual' | 'scheduled'; startedAt: string; finishedAt?: string; error?: string; output?: string };
