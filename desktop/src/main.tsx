...
function App({ initialState }: { initialState: DesktopState }) {
  ...
  const feedbackControl = <><FeedbackPanel connected={codexStatus === 'connected'} busy={serviceInUse} threadId={active?.remoteId} /><RemoteProjectsPanel connected={codexStatus === 'connected'} busy={serviceInUse} threadId={active?.remoteId} /></>;
