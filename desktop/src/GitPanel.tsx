...
export function GitPanel({ root, protectedPaths = [], onClose, onWorktree, onReview, onRecord }: { onRecord?: (action: string) => void; root?: string; protectedPaths?: string[]; onClose: () => void; onWorktree: (project: import('./domain').Project) => void; onReview: (text: string) => void }) {
