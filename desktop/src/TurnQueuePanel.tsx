...
export function TurnQueue({ items, onRemove, onResume, onPause, onBeginEdit, onEdit, disabled }: { items: QueuedTurn[]; onRemove: (id: string) => void; onResume: () => void; onPause: () => void; onBeginEdit: (id: string) => boolean; onEdit: (id: string, text: string) => boolean; disabled: boolean }) {
