...
export function TurnQueue({ items, onRemove, onResume, onPause, onBeginEdit, onEdit, onMove, disabled }: { items: QueuedTurn[]; onRemove: (id: string) => void; onResume: () => void; onPause: () => void; onBeginEdit: (id: string) => boolean; onEdit: (id: string, text: string, attachments: string[]) => boolean; onMove: (id: string, direction: -1 | 1) => void; disabled: boolean }) {
